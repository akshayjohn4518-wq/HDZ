...
export default function ProductDetailModal({ product, onClose, onOpenContact }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#050505]/95 backdrop-blur-xl overflow-y-auto font-mono text-white select-none">
      ...
      {/* FULL SYSTEM DEEP DIVE DRAWER / MODAL */}
      {initStage === 4 && (
